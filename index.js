...
// Validates if a string isn't null and contains > 1 non-space character
...
function validateForm(formData){
  ...
  if (!validateInput(formData.get("name"))) {
